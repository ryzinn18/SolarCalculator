...
def _get_iridescence_obj(params: dict) -> dict:
    ...
    LOGGER.info('Requesting the nrel api to retrieve solar potential data')
...
def get_solar_potential(address: str, annual_consumption: int) -> SolarPotentialData:
    ...
    :return ... THIS TOO ...
    """
    LOGGER.info(f'Attempting to retreive the solar potential data for the following address: {address}')
